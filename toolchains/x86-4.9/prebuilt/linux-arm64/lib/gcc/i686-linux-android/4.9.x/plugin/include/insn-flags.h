...
static inline rtx gen_movdi_insv_1                              (rtx, rtx);
static inline rtx
gen_movdi_insv_1(rtx ARG_UNUSED (a), rtx ARG_UNUSED (b))
{
  return 0;
}
...
static inline rtx gen_avx512f_vec_dup_gprv8di_mask              (rtx, rtx, rtx, rtx);
static inline rtx
gen_avx512f_vec_dup_gprv8di_mask(rtx ARG_UNUSED (a), rtx ARG_UNUSED (b), rtx ARG_UNUSED (c), rtx ARG_UNUSED (d))
{
  return 0;
}
...
static inline rtx gen_atomic_compare_and_swapti_doubleword      (rtx, rtx, rtx, rtx, rtx, rtx, rtx, rtx);
static inline rtx
gen_atomic_compare_and_swapti_doubleword(rtx ARG_UNUSED (a), rtx ARG_UNUSED (b), rtx ARG_UNUSED (c), rtx ARG_UNUSED (d), rtx ARG_UNUSED (e), rtx ARG_UNUSED (f), rtx ARG_UNUSED (g), rtx ARG_UNUSED (h))
{
  return 0;
}
