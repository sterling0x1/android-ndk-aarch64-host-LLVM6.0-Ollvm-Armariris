...
#endif
#ifdef GENERATOR_FILE
extern const char *flag_profile_generate_buildinfo;
#else
  const char *x_flag_profile_generate_buildinfo;
#define flag_profile_generate_buildinfo global_options.x_flag_profile_generate_buildinfo
#endif
#ifdef GENERATOR_FILE
...
#endif
#ifdef GENERATOR_FILE
extern int flag_dyn_ipa_allow_debug;
#else
  int x_flag_dyn_ipa_allow_debug;
#define flag_dyn_ipa_allow_debug global_options.x_flag_dyn_ipa_allow_debug
#endif
#ifdef GENERATOR_FILE
...
#endif
#ifdef GENERATOR_FILE
extern int flag_shrink_wrap_frame_pointer;
#else
  int x_flag_shrink_wrap_frame_pointer;
#define flag_shrink_wrap_frame_pointer global_options.x_flag_shrink_wrap_frame_pointer
#endif
#ifdef GENERATOR_FILE
...
#endif
#ifdef GENERATOR_FILE
extern int flag_two_level_all_subprogs;
#else
  int x_flag_two_level_all_subprogs;
#define flag_two_level_all_subprogs global_options.x_flag_two_level_all_subprogs
#endif
#ifdef GENERATOR_FILE
extern int flag_two_level_line_tables;
#else
  int x_flag_two_level_line_tables;
#define flag_two_level_line_tables global_options.x_flag_two_level_line_tables
#endif
#ifdef GENERATOR_FILE
...
#endif
#ifdef GENERATOR_FILE
extern int debug_line_tables_only;
#else
  int x_debug_line_tables_only;
#define debug_line_tables_only global_options.x_debug_line_tables_only
#endif
#ifdef GENERATOR_FILE
...
struct GTY(()) cl_optimization
{
  ...
  signed char x_flag_shrink_wrap_frame_pointer;
...
enum opt_code
{
  ...
  /* OPT__no_pie = 59, */                    /* --no-pie */
  /* OPT__no_standard_includes = 60, */      /* --no-standard-includes */
  /* OPT__no_standard_libraries = 61, */     /* --no-standard-libraries */
  OPT__no_sysroot_suffix = 62,               /* --no-sysroot-suffix */
  /* OPT__no_warnings = 63, */               /* --no-warnings */
  /* OPT__optimize = 64, */                  /* --optimize */
  /* OPT__output = 65, */                    /* --output */
  /* OPT__output_class_directory = 66, */    /* --output-class-directory */
  /* OPT__output_class_directory_ = 67, */   /* --output-class-directory= */
  OPT__output_pch_ = 68,                     /* --output-pch= */
  /* OPT__output_ = 69, */                   /* --output= */
  OPT__param = 70,                           /* --param */
  /* OPT__param_ = 71, */                    /* --param= */
  /* OPT__pass_exit_codes = 72, */           /* --pass-exit-codes */
  /* OPT__pedantic = 73, */                  /* --pedantic */
  /* OPT__pedantic_errors = 74, */           /* --pedantic-errors */
  /* OPT__pie = 75, */                       /* --pie */
  /* OPT__pipe = 76, */                      /* --pipe */
  /* OPT__prefix = 77, */                    /* --prefix */
  /* OPT__prefix_ = 78, */                   /* --prefix= */
  /* OPT__preprocess = 79, */                /* --preprocess */
  /* OPT__print_file_name = 80, */           /* --print-file-name */
  /* OPT__print_file_name_ = 81, */          /* --print-file-name= */
  /* OPT__print_libgcc_file_name = 82, */    /* --print-libgcc-file-name */
  /* OPT__print_missing_file_dependencies = 83, *//* --print-missing-file-dependencies */
  /* OPT__print_multi_directory = 84, */     /* --print-multi-directory */
  /* OPT__print_multi_lib = 85, */           /* --print-multi-lib */
  /* OPT__print_multi_os_directory = 86, */  /* --print-multi-os-directory */
  /* OPT__print_multiarch = 87, */           /* --print-multiarch */
  /* OPT__print_prog_name = 88, */           /* --print-prog-name */
  /* OPT__print_prog_name_ = 89, */          /* --print-prog-name= */
  /* OPT__print_search_dirs = 90, */         /* --print-search-dirs */
  /* OPT__print_sysroot = 91, */             /* --print-sysroot */
  /* OPT__print_sysroot_headers_suffix = 92, *//* --print-sysroot-headers-suffix */
  /* OPT__profile = 93, */                   /* --profile */
  /* OPT__resource = 94, */                  /* --resource */
  /* OPT__resource_ = 95, */                 /* --resource= */
  /* OPT__save_temps = 96, */                /* --save-temps */
  /* OPT__shared = 97, */                    /* --shared */
  /* OPT__specs = 98, */                     /* --specs */
  /* OPT__specs_ = 99, */                    /* --specs= */
  /* OPT__static = 100, */                   /* --static */
  /* OPT__symbolic = 101, */                 /* --symbolic */
  /* OPT__sysroot = 102, */                  /* --sysroot */
  OPT__sysroot_ = 103,                       /* --sysroot= */
  OPT__target_help = 104,                    /* --target-help */
  /* OPT__time = 105, */                     /* --time */
  /* OPT__trace_includes = 106, */           /* --trace-includes */
  /* OPT__traditional = 107, */              /* --traditional */
  /* OPT__traditional_cpp = 108, */          /* --traditional-cpp */
  /* OPT__trigraphs = 109, */                /* --trigraphs */
  /* OPT__undefine_macro = 110, */           /* --undefine-macro */
  /* OPT__undefine_macro_ = 111, */          /* --undefine-macro= */
  /* OPT__user_dependencies = 112, */        /* --user-dependencies */
  /* OPT__verbose = 113, */                  /* --verbose */
  OPT__version = 114,                        /* --version */
  /* OPT__write_dependencies = 115, */       /* --write-dependencies */
  /* OPT__write_user_dependencies = 116, */  /* --write-user-dependencies */
  OPT_A = 117,                               /* -A */
  OPT_B = 118,                               /* -B */
  OPT_C = 119,                               /* -C */
  OPT_CC = 120,                              /* -CC */
  /* OPT_CLASSPATH = 121, */                 /* -CLASSPATH */
  OPT_D = 122,                               /* -D */
  OPT_E = 123,                               /* -E */
  OPT_F = 124,                               /* -F */
  OPT_H = 125,                               /* -H */
  ...
  OPT_Wforce_warnings = 233,                 /* -Wforce-warnings */
  ...
  OPT_Wpoison_system_directories = 320,      /* -Wpoison-system-directories */
  ...
  OPT_Wripa_opt_mismatch = 334,              /* -Wripa-opt-mismatch */
  OPT_Wselector = 335,                       /* -Wselector */
  OPT_Wself_assign = 336,                    /* -Wself-assign */
  OPT_Wself_assign_non_pod = 337,            /* -Wself-assign-non-pod */
  OPT_Wsequence_point = 338,                 /* -Wsequence-point */
  OPT_Wserial = 339,                         /* -Wserial */
  OPT_Wshadow = 340,                         /* -Wshadow */
  OPT_Wshadow_compatible_local = 341,        /* -Wshadow-compatible-local */
  OPT_Wshadow_local = 342,                   /* -Wshadow-local */
  OPT_Wsign_compare = 343,                   /* -Wsign-compare */
  OPT_Wsign_conversion = 344,                /* -Wsign-conversion */
  OPT_Wsign_promo = 345,                     /* -Wsign-promo */
  OPT_Wsizeof_pointer_memaccess = 346,       /* -Wsizeof-pointer-memaccess */
  OPT_Wspecial_param_hiding = 347,           /* -Wspecial-param-hiding */
  OPT_Wstack_protector = 348,                /* -Wstack-protector */
  OPT_Wstack_usage_ = 349,                   /* -Wstack-usage= */
  OPT_Wstatic_access = 350,                  /* -Wstatic-access */
  OPT_Wstatic_receiver = 351,                /* -Wstatic-receiver */
  OPT_Wstrict_aliasing = 352,                /* -Wstrict-aliasing */
  OPT_Wstrict_aliasing_ = 353,               /* -Wstrict-aliasing= */
  OPT_Wstrict_null_sentinel = 354,           /* -Wstrict-null-sentinel */
  OPT_Wstrict_overflow = 355,                /* -Wstrict-overflow */
  OPT_Wstrict_overflow_ = 356,               /* -Wstrict-overflow= */
  OPT_Wstrict_prototypes = 357,              /* -Wstrict-prototypes */
  OPT_Wstrict_selector_match = 358,          /* -Wstrict-selector-match */
  OPT_Wsuggest_attribute_const = 359,        /* -Wsuggest-attribute=const */
  OPT_Wsuggest_attribute_format = 360,       /* -Wsuggest-attribute=format */
  OPT_Wsuggest_attribute_noreturn = 361,     /* -Wsuggest-attribute=noreturn */
  OPT_Wsuggest_attribute_pure = 362,         /* -Wsuggest-attribute=pure */
  OPT_Wsuppress = 363,                       /* -Wsuppress */
  OPT_Wsurprising = 364,                     /* -Wsurprising */
  OPT_Wswitch = 365,                         /* -Wswitch */
  OPT_Wswitch_default = 366,                 /* -Wswitch-default */
  OPT_Wswitch_enum = 367,                    /* -Wswitch-enum */
  OPT_Wsync_nand = 368,                      /* -Wsync-nand */
  OPT_Wsynth = 369,                          /* -Wsynth */
  OPT_Wsynthetic_access = 370,               /* -Wsynthetic-access */
  OPT_Wsystem_headers = 371,                 /* -Wsystem-headers */
  OPT_Wtabs = 372,                           /* -Wtabs */
  OPT_Wtarget_lifetime = 373,                /* -Wtarget-lifetime */
  OPT_Wtasks = 374,                          /* -Wtasks */
  OPT_Wthread_mismatched_lock_acq_rel = 375, /* -Wthread-mismatched-lock-acq-rel */
  OPT_Wthread_mismatched_lock_order = 376,   /* -Wthread-mismatched-lock-order */
  OPT_Wthread_reentrant_lock = 377,          /* -Wthread-reentrant-lock */
  OPT_Wthread_safety = 378,                  /* -Wthread-safety */
  /* OPT_Wthread_safety_analysis = 379, */   /* -Wthread-safety-analysis */
  /* OPT_Wthread_safety_attributes = 380, */ /* -Wthread-safety-attributes */
  /* OPT_Wthread_safety_precise = 381, */    /* -Wthread-safety-precise */
  OPT_Wthread_unguarded_func = 382,          /* -Wthread-unguarded-func */
  OPT_Wthread_unguarded_var = 383,           /* -Wthread-unguarded-var */
  OPT_Wthread_unsupported_lock_name = 384,   /* -Wthread-unsupported-lock-name */
  OPT_Wtraditional = 385,                    /* -Wtraditional */
  OPT_Wtraditional_conversion = 386,         /* -Wtraditional-conversion */
  OPT_Wtrampolines = 387,                    /* -Wtrampolines */
  OPT_Wtrigraphs = 388,                      /* -Wtrigraphs */
  OPT_Wtype_hiding = 389,                    /* -Wtype-hiding */
  OPT_Wtype_limits = 390,                    /* -Wtype-limits */
  OPT_Wuncheck = 391,                        /* -Wuncheck */
  OPT_Wundeclared_selector = 392,            /* -Wundeclared-selector */
  OPT_Wundef = 393,                          /* -Wundef */
  OPT_Wunderflow = 394,                      /* -Wunderflow */
  OPT_Wuninitialized = 395,                  /* -Wuninitialized */
  OPT_Wunknown_pragmas = 396,                /* -Wunknown-pragmas */
  OPT_Wunnecessary_else = 397,               /* -Wunnecessary-else */
  OPT_Wunqualified_field = 398,              /* -Wunqualified-field */
  /* OPT_Wunreachable_code = 399, */         /* -Wunreachable-code */
  OPT_Wunsafe_loop_optimizations = 400,      /* -Wunsafe-loop-optimizations */
  OPT_Wunsuffixed_float_constants = 401,     /* -Wunsuffixed-float-constants */
  OPT_Wunused = 402,                         /* -Wunused */
  OPT_Wunused_argument = 403,                /* -Wunused-argument */
  OPT_Wunused_but_set_parameter = 404,       /* -Wunused-but-set-parameter */
  OPT_Wunused_but_set_variable = 405,        /* -Wunused-but-set-variable */
  OPT_Wunused_dummy_argument = 406,          /* -Wunused-dummy-argument */
  OPT_Wunused_function = 407,                /* -Wunused-function */
  OPT_Wunused_import = 408,                  /* -Wunused-import */
  OPT_Wunused_label = 409,                   /* -Wunused-label */
  OPT_Wunused_local = 410,                   /* -Wunused-local */
  OPT_Wunused_local_typedefs = 411,          /* -Wunused-local-typedefs */
  OPT_Wunused_macros = 412,                  /* -Wunused-macros */
  OPT_Wunused_parameter = 413,               /* -Wunused-parameter */
  OPT_Wunused_private = 414,                 /* -Wunused-private */
  OPT_Wunused_result = 415,                  /* -Wunused-result */
  OPT_Wunused_thrown = 416,                  /* -Wunused-thrown */
  OPT_Wunused_value = 417,                   /* -Wunused-value */
  OPT_Wunused_variable = 418,                /* -Wunused-variable */
  OPT_Wuseless_cast = 419,                   /* -Wuseless-cast */
  OPT_Wuseless_type_check = 420,             /* -Wuseless-type-check */
  OPT_Wvarargs = 421,                        /* -Wvarargs */
  OPT_Wvarargs_cast = 422,                   /* -Wvarargs-cast */
  OPT_Wvariadic_macros = 423,                /* -Wvariadic-macros */
  OPT_Wvector_operation_performance = 424,   /* -Wvector-operation-performance */
  OPT_Wvirtual_move_assign = 425,            /* -Wvirtual-move-assign */
  OPT_Wvla = 426,                            /* -Wvla */
  OPT_Wvolatile_register_var = 427,          /* -Wvolatile-register-var */
  OPT_Wwarning_token = 428,                  /* -Wwarning-token */
  OPT_Wwrite_strings = 429,                  /* -Wwrite-strings */
  OPT_Wzero_as_null_pointer_constant = 430,  /* -Wzero-as-null-pointer-constant */
  OPT_Wzerotrip = 431,                       /* -Wzerotrip */
  OPT_Xassembler = 432,                      /* -Xassembler */
  /* OPT_Xclang_only_ = 433, */              /* -Xclang-only= */
  OPT_Xlinker = 434,                         /* -Xlinker */
  OPT_Xpreprocessor = 435,                   /* -Xpreprocessor */
  OPT_Z = 436,                               /* -Z */
  OPT_ansi = 437,                            /* -ansi */
  OPT_aux_info = 438,                        /* -aux-info */
  /* OPT_aux_info_ = 439, */                 /* -aux-info= */
  OPT_auxbase = 440,                         /* -auxbase */
  OPT_auxbase_strip = 441,                   /* -auxbase-strip */
  /* OPT_bootclasspath = 442, */             /* -bootclasspath */
  OPT_c = 443,                               /* -c */
  OPT_canonical_prefixes = 444,              /* -canonical-prefixes */
  /* OPT_classpath = 445, */                 /* -classpath */
  OPT_coverage = 446,                        /* -coverage */
  OPT_cpp = 447,                             /* -cpp */
  OPT_cpp_ = 448,                            /* -cpp= */
  OPT_d = 449,                               /* -d */
  OPT_dumpbase = 450,                        /* -dumpbase */
  OPT_dumpdir = 451,                         /* -dumpdir */
  OPT_dumpmachine = 452,                     /* -dumpmachine */
  OPT_dumpspecs = 453,                       /* -dumpspecs */
  OPT_dumpversion = 454,                     /* -dumpversion */
  OPT_e = 455,                               /* -e */
  /* OPT_encoding = 456, */                  /* -encoding */
  OPT_export_dynamic = 457,                  /* -export-dynamic */
  OPT_extdirs = 458,                         /* -extdirs */
  ...
  OPT_fall_intrinsics = 477,                 /* -fall-intrinsics */
  /* OPT_fall_virtual = 478, */              /* -fall-virtual */
  OPT_fallow_leading_underscore = 479,       /* -fallow-leading-underscore */
  OPT_fallow_parameterless_variadic_functions = 480,/* -fallow-parameterless-variadic-functions */
  /* OPT_falt_external_templates = 481, */   /* -falt-external-templates */
  /* OPT_fargument_alias = 482, */           /* -fargument-alias */
  /* OPT_fargument_noalias = 483, */         /* -fargument-noalias */
  /* OPT_fargument_noalias_anything = 484, *//* -fargument-noalias-anything */
  /* OPT_fargument_noalias_global = 485, */  /* -fargument-noalias-global */
  OPT_fasm = 486,                            /* -fasm */
  OPT_fassert = 487,                         /* -fassert */
  OPT_fassociative_math = 488,               /* -fassociative-math */
  OPT_fassume_compiled = 489,                /* -fassume-compiled */
  OPT_fassume_compiled_ = 490,               /* -fassume-compiled= */
  ...
  OPT_fauto_profile_accurate = 494,          /* -fauto-profile-accurate */
  OPT_fauto_profile_record_coverage_in_elf = 495,/* -fauto-profile-record-coverage-in-elf */
  OPT_fauto_profile_ = 496,                  /* -fauto-profile= */
  OPT_fautomatic = 497,                      /* -fautomatic */
  OPT_faux_classpath = 498,                  /* -faux-classpath */
  OPT_fbackslash = 499,                      /* -fbackslash */
  OPT_fbacktrace = 500,                      /* -fbacktrace */
  OPT_fblas_matmul_limit_ = 501,             /* -fblas-matmul-limit= */
  OPT_fbootclasspath_ = 502,                 /* -fbootclasspath= */
  OPT_fbootstrap_classes = 503,              /* -fbootstrap-classes */
  OPT_fbounds_check = 504,                   /* -fbounds-check */
  OPT_fbranch_count_reg = 505,               /* -fbranch-count-reg */
  OPT_fbranch_probabilities = 506,           /* -fbranch-probabilities */
  OPT_fbranch_target_load_optimize = 507,    /* -fbranch-target-load-optimize */
  OPT_fbranch_target_load_optimize2 = 508,   /* -fbranch-target-load-optimize2 */
  OPT_fbtr_bb_exclusive = 509,               /* -fbtr-bb-exclusive */
  OPT_fbuilding_libgcc = 510,                /* -fbuilding-libgcc */
  OPT_fbuiltin = 511,                        /* -fbuiltin */
  OPT_fbuiltin_ = 512,                       /* -fbuiltin- */
  OPT_fcall_saved_ = 513,                    /* -fcall-saved- */
  OPT_fcall_used_ = 514,                     /* -fcall-used- */
  OPT_fcaller_saves = 515,                   /* -fcaller-saves */
  OPT_fcanonical_system_headers = 516,       /* -fcanonical-system-headers */
  OPT_fcheck_array_temporaries = 517,        /* -fcheck-array-temporaries */
  OPT_fcheck_branch_annotation = 518,        /* -fcheck-branch-annotation */
  OPT_fcheck_branch_annotation_threshold_ = 519,/* -fcheck-branch-annotation-threshold= */
  OPT_fcheck_data_deps = 520,                /* -fcheck-data-deps */
  OPT_fcheck_new = 521,                      /* -fcheck-new */
  OPT_fcheck_references = 522,               /* -fcheck-references */
  OPT_fcheck_ = 523,                         /* -fcheck= */
  OPT_fcilkplus = 524,                       /* -fcilkplus */
  OPT_fclasspath_ = 525,                     /* -fclasspath= */
  OPT_fcoarray_ = 526,                       /* -fcoarray= */
  OPT_fcombine_stack_adjustments = 527,      /* -fcombine-stack-adjustments */
  OPT_fcommon = 528,                         /* -fcommon */
  OPT_fcompare_debug = 529,                  /* -fcompare-debug */
  OPT_fcompare_debug_second = 530,           /* -fcompare-debug-second */
  OPT_fcompare_debug_ = 531,                 /* -fcompare-debug= */
  OPT_fcompare_elim = 532,                   /* -fcompare-elim */
  OPT_fcompile_resource_ = 533,              /* -fcompile-resource= */
  OPT_fcond_mismatch = 534,                  /* -fcond-mismatch */
  OPT_fconserve_space = 535,                 /* -fconserve-space */
  OPT_fconserve_stack = 536,                 /* -fconserve-stack */
  OPT_fconstant_string_class_ = 537,         /* -fconstant-string-class= */
  OPT_fconstexpr_depth_ = 538,               /* -fconstexpr-depth= */
  OPT_fconvert_big_endian = 539,             /* -fconvert=big-endian */
  OPT_fconvert_little_endian = 540,          /* -fconvert=little-endian */
  OPT_fconvert_native = 541,                 /* -fconvert=native */
  OPT_fconvert_swap = 542,                   /* -fconvert=swap */
  OPT_fcprop_registers = 543,                /* -fcprop-registers */
  OPT_fcray_pointer = 544,                   /* -fcray-pointer */
  OPT_fcrossjumping = 545,                   /* -fcrossjumping */
  OPT_fcse_follow_jumps = 546,               /* -fcse-follow-jumps */
  /* OPT_fcse_skip_blocks = 547, */          /* -fcse-skip-blocks */
  OPT_fcx_fortran_rules = 548,               /* -fcx-fortran-rules */
  OPT_fcx_limited_range = 549,               /* -fcx-limited-range */
  OPT_fd_lines_as_code = 550,                /* -fd-lines-as-code */
  OPT_fd_lines_as_comments = 551,            /* -fd-lines-as-comments */
  OPT_fdata_sections = 552,                  /* -fdata-sections */
  OPT_fdbg_cnt_list = 553,                   /* -fdbg-cnt-list */
  OPT_fdbg_cnt_ = 554,                       /* -fdbg-cnt= */
  OPT_fdce = 555,                            /* -fdce */
  OPT_fdebug_cpp = 556,                      /* -fdebug-cpp */
  OPT_fdebug_prefix_map_ = 557,              /* -fdebug-prefix-map= */
  OPT_fdebug_types_section = 558,            /* -fdebug-types-section */
  OPT_fdeclone_ctor_dtor = 559,              /* -fdeclone-ctor-dtor */
  OPT_fdeduce_init_list = 560,               /* -fdeduce-init-list */
  OPT_fdefault_double_8 = 561,               /* -fdefault-double-8 */
  /* OPT_fdefault_inline = 562, */           /* -fdefault-inline */
  OPT_fdefault_integer_8 = 563,              /* -fdefault-integer-8 */
  OPT_fdefault_noexcept = 564,               /* -fdefault-noexcept */
  OPT_fdefault_real_8 = 565,                 /* -fdefault-real-8 */
  OPT_fdefer_pop = 566,                      /* -fdefer-pop */
  OPT_fdelayed_branch = 567,                 /* -fdelayed-branch */
  OPT_fdelete_dead_exceptions = 568,         /* -fdelete-dead-exceptions */
  OPT_fdelete_null_pointer_checks = 569,     /* -fdelete-null-pointer-checks */
  OPT_fdevirtualize = 570,                   /* -fdevirtualize */
  OPT_fdevirtualize_speculatively = 571,     /* -fdevirtualize-speculatively */
  /* OPT_fdiagnostics_color = 572, */        /* -fdiagnostics-color */
  OPT_fdiagnostics_color_ = 573,             /* -fdiagnostics-color= */
  OPT_fdiagnostics_show_caret = 574,         /* -fdiagnostics-show-caret */
  OPT_fdiagnostics_show_location_ = 575,     /* -fdiagnostics-show-location= */
  OPT_fdiagnostics_show_option = 576,        /* -fdiagnostics-show-option */
  OPT_fdirectives_only = 577,                /* -fdirectives-only */
  OPT_fdisable_ = 578,                       /* -fdisable- */
  OPT_fdisable_assertions = 579,             /* -fdisable-assertions */
  OPT_fdisable_assertions_ = 580,            /* -fdisable-assertions= */
  OPT_fdollar_ok = 581,                      /* -fdollar-ok */
  OPT_fdollars_in_identifiers = 582,         /* -fdollars-in-identifiers */
  OPT_fdse = 583,                            /* -fdse */
  OPT_fdump_ = 584,                          /* -fdump- */
  OPT_fdump_ada_spec = 585,                  /* -fdump-ada-spec */
  OPT_fdump_ada_spec_slim = 586,             /* -fdump-ada-spec-slim */
  /* OPT_fdump_core = 587, */                /* -fdump-core */
  OPT_fdump_final_insns = 588,               /* -fdump-final-insns */
  OPT_fdump_final_insns_ = 589,              /* -fdump-final-insns= */
  OPT_fdump_fortran_optimized = 590,         /* -fdump-fortran-optimized */
  OPT_fdump_fortran_original = 591,          /* -fdump-fortran-original */
  OPT_fdump_go_spec_ = 592,                  /* -fdump-go-spec= */
  OPT_fdump_noaddr = 593,                    /* -fdump-noaddr */
  OPT_fdump_parse_tree = 594,                /* -fdump-parse-tree */
  OPT_fdump_passes = 595,                    /* -fdump-passes */
  OPT_fdump_unnumbered = 596,                /* -fdump-unnumbered */
  OPT_fdump_unnumbered_links = 597,          /* -fdump-unnumbered-links */
  OPT_fdwarf2_cfi_asm = 598,                 /* -fdwarf2-cfi-asm */
  OPT_fearly_inlining = 599,                 /* -fearly-inlining */
  OPT_felide_constructors = 600,             /* -felide-constructors */
  OPT_feliminate_dwarf2_dups = 601,          /* -feliminate-dwarf2-dups */
  OPT_feliminate_unused_debug_symbols = 602, /* -feliminate-unused-debug-symbols */
  OPT_feliminate_unused_debug_types = 603,   /* -feliminate-unused-debug-types */
  OPT_femit_class_debug_always = 604,        /* -femit-class-debug-always */
  OPT_femit_class_file = 605,                /* -femit-class-file */
  OPT_femit_class_files = 606,               /* -femit-class-files */
  OPT_femit_function_names = 607,            /* -femit-function-names */
  OPT_femit_struct_debug_baseonly = 608,     /* -femit-struct-debug-baseonly */
  OPT_femit_struct_debug_detailed_ = 609,    /* -femit-struct-debug-detailed= */
  OPT_femit_struct_debug_reduced = 610,      /* -femit-struct-debug-reduced */
  OPT_fenable_ = 611,                        /* -fenable- */
  OPT_fenable_assertions = 612,              /* -fenable-assertions */
  OPT_fenable_assertions_ = 613,             /* -fenable-assertions= */
  OPT_fencoding_ = 614,                      /* -fencoding= */
  OPT_fenforce_eh_specs = 615,               /* -fenforce-eh-specs */
  /* OPT_fenum_int_equiv = 616, */           /* -fenum-int-equiv */
  OPT_fexceptions = 617,                     /* -fexceptions */
  OPT_fexcess_precision_ = 618,              /* -fexcess-precision= */
  OPT_fexec_charset_ = 619,                  /* -fexec-charset= */
  OPT_fexpensive_optimizations = 620,        /* -fexpensive-optimizations */
  OPT_fext_numeric_literals = 621,           /* -fext-numeric-literals */
  OPT_fextdirs_ = 622,                       /* -fextdirs= */
  OPT_fextended_identifiers = 623,           /* -fextended-identifiers */
  OPT_fextern_tls_init = 624,                /* -fextern-tls-init */
  OPT_fexternal_blas = 625,                  /* -fexternal-blas */
  /* OPT_fexternal_templates = 626, */       /* -fexternal-templates */
  OPT_ff2c = 627,                            /* -ff2c */
  OPT_ffast_math = 628,                      /* -ffast-math */
  OPT_ffat_lto_objects = 629,                /* -ffat-lto-objects */
  OPT_ffilelist_file = 630,                  /* -ffilelist-file */
  OPT_ffinite_math_only = 631,               /* -ffinite-math-only */
  OPT_ffixed_ = 632,                         /* -ffixed- */
  OPT_ffixed_form = 633,                     /* -ffixed-form */
  OPT_ffixed_line_length_ = 634,             /* -ffixed-line-length- */
  OPT_ffixed_line_length_none = 635,         /* -ffixed-line-length-none */
  OPT_ffloat_store = 636,                    /* -ffloat-store */
  OPT_ffor_scope = 637,                      /* -ffor-scope */
  /* OPT_fforce_addr = 638, */               /* -fforce-addr */
  OPT_fforce_classes_archive_check = 639,    /* -fforce-classes-archive-check */
  OPT_fforward_propagate = 640,              /* -fforward-propagate */
  OPT_ffp_contract_ = 641,                   /* -ffp-contract= */
  OPT_ffpe_summary_ = 642,                   /* -ffpe-summary= */
  OPT_ffpe_trap_ = 643,                      /* -ffpe-trap= */
  OPT_ffree_form = 644,                      /* -ffree-form */
  OPT_ffree_line_length_ = 645,              /* -ffree-line-length- */
  OPT_ffree_line_length_none = 646,          /* -ffree-line-length-none */
  OPT_ffreestanding = 647,                   /* -ffreestanding */
  OPT_ffriend_injection = 648,               /* -ffriend-injection */
  OPT_ffrontend_optimize = 649,              /* -ffrontend-optimize */
  OPT_ffunction_attribute_list_ = 650,       /* -ffunction-attribute-list= */
  OPT_ffunction_cse = 651,                   /* -ffunction-cse */
  OPT_ffunction_sections = 652,              /* -ffunction-sections */
  OPT_fgcse = 653,                           /* -fgcse */
  OPT_fgcse_after_reload = 654,              /* -fgcse-after-reload */
  OPT_fgcse_las = 655,                       /* -fgcse-las */
  OPT_fgcse_lm = 656,                        /* -fgcse-lm */
  OPT_fgcse_sm = 657,                        /* -fgcse-sm */
  OPT_fgnu_keywords = 658,                   /* -fgnu-keywords */
  OPT_fgnu_runtime = 659,                    /* -fgnu-runtime */
  OPT_fgnu_tm = 660,                         /* -fgnu-tm */
  OPT_fgnu_unique = 661,                     /* -fgnu-unique */
  OPT_fgnu89_inline = 662,                   /* -fgnu89-inline */
  OPT_fgo_check_divide_overflow = 663,       /* -fgo-check-divide-overflow */
  OPT_fgo_check_divide_zero = 664,           /* -fgo-check-divide-zero */
  OPT_fgo_dump_ = 665,                       /* -fgo-dump- */
  OPT_fgo_optimize_ = 666,                   /* -fgo-optimize- */
  OPT_fgo_pkgpath_ = 667,                    /* -fgo-pkgpath= */
  OPT_fgo_prefix_ = 668,                     /* -fgo-prefix= */
  OPT_fgo_relative_import_path_ = 669,       /* -fgo-relative-import-path= */
  OPT_fgraphite = 670,                       /* -fgraphite */
  OPT_fgraphite_identity = 671,              /* -fgraphite-identity */
  OPT_fguess_branch_probability = 672,       /* -fguess-branch-probability */
  /* OPT_fguiding_decls = 673, */            /* -fguiding-decls */
  /* OPT_fhandle_exceptions = 674, */        /* -fhandle-exceptions */
  OPT_fhash_synchronization = 675,           /* -fhash-synchronization */
  /* OPT_fhelp = 676, */                     /* -fhelp */
  /* OPT_fhelp_ = 677, */                    /* -fhelp= */
  OPT_fhoist_adjacent_loads = 678,           /* -fhoist-adjacent-loads */
  /* OPT_fhonor_std = 679, */                /* -fhonor-std */
  OPT_fhosted = 680,                         /* -fhosted */
  /* OPT_fhuge_objects = 681, */             /* -fhuge-objects */
  OPT_fident = 682,                          /* -fident */
  OPT_fif_conversion = 683,                  /* -fif-conversion */
  OPT_fif_conversion2 = 684,                 /* -fif-conversion2 */
  OPT_fimplement_inlines = 685,              /* -fimplement-inlines */
  OPT_fimplicit_inline_templates = 686,      /* -fimplicit-inline-templates */
  OPT_fimplicit_none = 687,                  /* -fimplicit-none */
  OPT_fimplicit_templates = 688,             /* -fimplicit-templates */
  OPT_findirect_classes = 689,               /* -findirect-classes */
  OPT_findirect_dispatch = 690,              /* -findirect-dispatch */
  OPT_findirect_inlining = 691,              /* -findirect-inlining */
  OPT_finhibit_size_directive = 692,         /* -finhibit-size-directive */
  OPT_finit_character_ = 693,                /* -finit-character= */
  OPT_finit_integer_ = 694,                  /* -finit-integer= */
  OPT_finit_local_zero = 695,                /* -finit-local-zero */
  OPT_finit_logical_ = 696,                  /* -finit-logical= */
  OPT_finit_real_ = 697,                     /* -finit-real= */
  OPT_finline = 698,                         /* -finline */
  OPT_finline_atomics = 699,                 /* -finline-atomics */
  OPT_finline_functions = 700,               /* -finline-functions */
  OPT_finline_functions_called_once = 701,   /* -finline-functions-called-once */
  /* OPT_finline_limit_ = 702, */            /* -finline-limit- */
  OPT_finline_limit_ = 703,                  /* -finline-limit= */
  OPT_finline_small_functions = 704,         /* -finline-small-functions */
  OPT_finput_charset_ = 705,                 /* -finput-charset= */
  OPT_finstrument_functions = 706,           /* -finstrument-functions */
  OPT_finstrument_functions_exclude_file_list_ = 707,/* -finstrument-functions-exclude-file-list= */
  OPT_finstrument_functions_exclude_function_list_ = 708,/* -finstrument-functions-exclude-function-list= */
  OPT_finteger_4_integer_8 = 709,            /* -finteger-4-integer-8 */
  OPT_fintrinsic_modules_path = 710,         /* -fintrinsic-modules-path */
  OPT_fintrinsic_modules_path_ = 711,        /* -fintrinsic-modules-path= */
  OPT_fipa_cp = 712,                         /* -fipa-cp */
  OPT_fipa_cp_clone = 713,                   /* -fipa-cp-clone */
  /* OPT_fipa_matrix_reorg = 714, */         /* -fipa-matrix-reorg */
  OPT_fipa_profile = 715,                    /* -fipa-profile */
  OPT_fipa_pta = 716,                        /* -fipa-pta */
  OPT_fipa_pure_const = 717,                 /* -fipa-pure-const */
  OPT_fipa_reference = 718,                  /* -fipa-reference */
  OPT_fipa_sra = 719,                        /* -fipa-sra */
  /* OPT_fipa_struct_reorg = 720, */         /* -fipa-struct-reorg */
  OPT_fira_algorithm_ = 721,                 /* -fira-algorithm= */
  OPT_fira_hoist_pressure = 722,             /* -fira-hoist-pressure */
  OPT_fira_loop_pressure = 723,              /* -fira-loop-pressure */
  OPT_fira_region_ = 724,                    /* -fira-region= */
  OPT_fira_share_save_slots = 725,           /* -fira-share-save-slots */
  OPT_fira_share_spill_slots = 726,          /* -fira-share-spill-slots */
  OPT_fira_verbose_ = 727,                   /* -fira-verbose= */
  OPT_fisolate_erroneous_paths_attribute = 728,/* -fisolate-erroneous-paths-attribute */
  OPT_fisolate_erroneous_paths_dereference = 729,/* -fisolate-erroneous-paths-dereference */
  OPT_fivopts = 730,                         /* -fivopts */
  OPT_fjni = 731,                            /* -fjni */
  OPT_fjump_tables = 732,                    /* -fjump-tables */
  OPT_fkeep_inline_dllexport = 733,          /* -fkeep-inline-dllexport */
  OPT_fkeep_inline_functions = 734,          /* -fkeep-inline-functions */
  OPT_fkeep_static_consts = 735,             /* -fkeep-static-consts */
  /* OPT_flabels_ok = 736, */                /* -flabels-ok */
  OPT_flax_vector_conversions = 737,         /* -flax-vector-conversions */
  OPT_fleading_underscore = 738,             /* -fleading-underscore */
  OPT_flifetime_dse = 739,                   /* -flifetime-dse */
  OPT_flive_range_shrinkage = 740,           /* -flive-range-shrinkage */
  OPT_floop_block = 741,                     /* -floop-block */
  /* OPT_floop_flatten = 742, */             /* -floop-flatten */
  OPT_floop_interchange = 743,               /* -floop-interchange */
  OPT_floop_nest_optimize = 744,             /* -floop-nest-optimize */
  /* OPT_floop_optimize = 745, */            /* -floop-optimize */
  OPT_floop_parallelize_all = 746,           /* -floop-parallelize-all */
  OPT_floop_strip_mine = 747,                /* -floop-strip-mine */
  OPT_flto = 748,                            /* -flto */
  OPT_flto_compression_level_ = 749,         /* -flto-compression-level= */
  OPT_flto_partition_1to1 = 750,             /* -flto-partition=1to1 */
  OPT_flto_partition_balanced = 751,         /* -flto-partition=balanced */
  OPT_flto_partition_max = 752,              /* -flto-partition=max */
  OPT_flto_partition_none = 753,             /* -flto-partition=none */
  OPT_flto_report = 754,                     /* -flto-report */
  OPT_flto_report_wpa = 755,                 /* -flto-report-wpa */
  OPT_flto_ = 756,                           /* -flto= */
  OPT_fltrans = 757,                         /* -fltrans */
  OPT_fltrans_output_list_ = 758,            /* -fltrans-output-list= */
  OPT_fmain_ = 759,                          /* -fmain= */
  OPT_fmath_errno = 760,                     /* -fmath-errno */
  OPT_fmax_array_constructor_ = 761,         /* -fmax-array-constructor= */
  OPT_fmax_errors_ = 762,                    /* -fmax-errors= */
  OPT_fmax_identifier_length_ = 763,         /* -fmax-identifier-length= */
  OPT_fmax_stack_var_size_ = 764,            /* -fmax-stack-var-size= */
  OPT_fmax_subrecord_length_ = 765,          /* -fmax-subrecord-length= */
  OPT_fmem_report = 766,                     /* -fmem-report */
  OPT_fmem_report_wpa = 767,                 /* -fmem-report-wpa */
  OPT_fmerge_all_constants = 768,            /* -fmerge-all-constants */
  OPT_fmerge_constants = 769,                /* -fmerge-constants */
  OPT_fmerge_debug_strings = 770,            /* -fmerge-debug-strings */
  OPT_fmessage_length_ = 771,                /* -fmessage-length= */
  OPT_fmodule_private = 772,                 /* -fmodule-private */
  OPT_fmodulo_sched = 773,                   /* -fmodulo-sched */
  OPT_fmodulo_sched_allow_regmoves = 774,    /* -fmodulo-sched-allow-regmoves */
  OPT_fmove_loop_invariants = 775,           /* -fmove-loop-invariants */
  OPT_fms_extensions = 776,                  /* -fms-extensions */
  /* OPT_fmudflap = 777, */                  /* -fmudflap */
  /* OPT_fmudflapir = 778, */                /* -fmudflapir */
  /* OPT_fmudflapth = 779, */                /* -fmudflapth */
  /* OPT_fname_mangling_version_ = 780, */   /* -fname-mangling-version- */
  /* OPT_fnew_abi = 781, */                  /* -fnew-abi */
  OPT_fnext_runtime = 782,                   /* -fnext-runtime */
  OPT_fnil_receivers = 783,                  /* -fnil-receivers */
  /* OPT_fno_vect_cost_model = 784, */       /* -fno-vect-cost-model */
  OPT_fnon_call_exceptions = 785,            /* -fnon-call-exceptions */
  OPT_fnonansi_builtins = 786,               /* -fnonansi-builtins */
  /* OPT_fnonnull_objects = 787, */          /* -fnonnull-objects */
  OPT_fnothrow_opt = 788,                    /* -fnothrow-opt */
  OPT_fobjc_abi_version_ = 789,              /* -fobjc-abi-version= */
  OPT_fobjc_call_cxx_cdtors = 790,           /* -fobjc-call-cxx-cdtors */
  OPT_fobjc_direct_dispatch = 791,           /* -fobjc-direct-dispatch */
  OPT_fobjc_exceptions = 792,                /* -fobjc-exceptions */
  OPT_fobjc_gc = 793,                        /* -fobjc-gc */
  OPT_fobjc_nilcheck = 794,                  /* -fobjc-nilcheck */
  OPT_fobjc_sjlj_exceptions = 795,           /* -fobjc-sjlj-exceptions */
  OPT_fobjc_std_objc1 = 796,                 /* -fobjc-std=objc1 */
  OPT_fomit_frame_pointer = 797,             /* -fomit-frame-pointer */
  OPT_fopenmp = 798,                         /* -fopenmp */
  OPT_fopenmp_simd = 799,                    /* -fopenmp-simd */
  OPT_foperator_names = 800,                 /* -foperator-names */
  OPT_fopt_info = 801,                       /* -fopt-info */
  OPT_fopt_info_ = 802,                      /* -fopt-info- */
  /* OPT_foptimize_register_move = 803, */   /* -foptimize-register-move */
  OPT_foptimize_sibling_calls = 804,         /* -foptimize-sibling-calls */
  OPT_foptimize_static_class_initialization = 805,/* -foptimize-static-class-initialization */
  OPT_foptimize_strlen = 806,                /* -foptimize-strlen */
  /* OPT_foptional_diags = 807, */           /* -foptional-diags */
  OPT_foutput_class_dir_ = 808,              /* -foutput-class-dir= */
  OPT_fpack_derived = 809,                   /* -fpack-derived */
  OPT_fpack_struct = 810,                    /* -fpack-struct */
  OPT_fpack_struct_ = 811,                   /* -fpack-struct= */
  OPT_fpartial_inlining = 812,               /* -fpartial-inlining */
  OPT_fpcc_struct_return = 813,              /* -fpcc-struct-return */
  OPT_fpch_deps = 814,                       /* -fpch-deps */
  OPT_fpch_preprocess = 815,                 /* -fpch-preprocess */
  OPT_fpeel_codesize_limit = 816,            /* -fpeel-codesize-limit */
  OPT_fpeel_loops = 817,                     /* -fpeel-loops */
  OPT_fpeephole = 818,                       /* -fpeephole */
  OPT_fpeephole2 = 819,                      /* -fpeephole2 */
  OPT_fpermissive = 820,                     /* -fpermissive */
  OPT_fpic = 821,                            /* -fpic */
  OPT_fpie = 822,                            /* -fpie */
  OPT_fplan9_extensions = 823,               /* -fplan9-extensions */
  OPT_fplt = 824,                            /* -fplt */
  OPT_fplugin_arg_ = 825,                    /* -fplugin-arg- */
  OPT_fplugin_ = 826,                        /* -fplugin= */
  OPT_fpost_ipa_mem_report = 827,            /* -fpost-ipa-mem-report */
  OPT_fpre_ipa_mem_report = 828,             /* -fpre-ipa-mem-report */
  OPT_fpredictive_commoning = 829,           /* -fpredictive-commoning */
  OPT_fprefetch_loop_arrays = 830,           /* -fprefetch-loop-arrays */
  OPT_fpreprocessed = 831,                   /* -fpreprocessed */
  OPT_fpretty_templates = 832,               /* -fpretty-templates */
  OPT_fprofile = 833,                        /* -fprofile */
  OPT_fprofile_arcs = 834,                   /* -fprofile-arcs */
  OPT_fprofile_correction = 835,             /* -fprofile-correction */
  OPT_fprofile_dir_ = 836,                   /* -fprofile-dir= */
  OPT_fprofile_dump = 837,                   /* -fprofile-dump */
  OPT_fprofile_generate = 838,               /* -fprofile-generate */
  OPT_fprofile_generate_atomic_ = 839,       /* -fprofile-generate-atomic= */
  OPT_fprofile_generate_buildinfo_ = 840,    /* -fprofile-generate-buildinfo= */
  OPT_fprofile_generate_sampling = 841,      /* -fprofile-generate-sampling */
  OPT_fprofile_generate_ = 842,              /* -fprofile-generate= */
  OPT_fprofile_reorder_functions = 843,      /* -fprofile-reorder-functions */
  OPT_fprofile_report = 844,                 /* -fprofile-report */
  OPT_fprofile_strip_ = 845,                 /* -fprofile-strip= */
  OPT_fprofile_use = 846,                    /* -fprofile-use */
  OPT_fprofile_use_ = 847,                   /* -fprofile-use= */
  OPT_fprofile_values = 848,                 /* -fprofile-values */
  OPT_fprotect_parens = 849,                 /* -fprotect-parens */
  ...
  OPT_frecord_compilation_info_in_elf = 861, /* -frecord-compilation-info-in-elf */
  OPT_frecord_gcc_switches = 862,            /* -frecord-gcc-switches */
  OPT_frecord_marker_4 = 863,                /* -frecord-marker=4 */
  OPT_frecord_marker_8 = 864,                /* -frecord-marker=8 */
  OPT_frecursive = 865,                      /* -frecursive */
  OPT_freduced_reflection = 866,             /* -freduced-reflection */
  OPT_free = 867,                            /* -free */
  OPT_freg_struct_return = 868,              /* -freg-struct-return */
  /* OPT_fregmove = 869, */                  /* -fregmove */
  OPT_frename_registers = 870,               /* -frename-registers */
  OPT_freorder_blocks = 871,                 /* -freorder-blocks */
  OPT_freorder_blocks_and_partition = 872,   /* -freorder-blocks-and-partition */
  OPT_freorder_functions = 873,              /* -freorder-functions */
  OPT_freorder_functions_ = 874,             /* -freorder-functions= */
  OPT_frepack_arrays = 875,                  /* -frepack-arrays */
  OPT_freplace_objc_classes = 876,           /* -freplace-objc-classes */
  OPT_frepo = 877,                           /* -frepo */
  OPT_frequire_return_statement = 878,       /* -frequire-return-statement */
  OPT_frerun_cse_after_loop = 879,           /* -frerun-cse-after-loop */
  /* OPT_frerun_loop_opt = 880, */           /* -frerun-loop-opt */
  OPT_freschedule_modulo_scheduled_loops = 881,/* -freschedule-modulo-scheduled-loops */
  OPT_fresolution_ = 882,                    /* -fresolution= */
  OPT_fripa = 883,                           /* -fripa */
  OPT_fripa_allow_debug = 884,               /* -fripa-allow-debug */
  OPT_fripa_disallow_asm_modules = 885,      /* -fripa-disallow-asm-modules */
  OPT_fripa_disallow_opt_mismatch = 886,     /* -fripa-disallow-opt-mismatch */
  OPT_fripa_inc_path_sub_ = 887,             /* -fripa-inc-path-sub= */
  OPT_fripa_no_promote_always_inline_func = 888,/* -fripa-no-promote-always-inline-func */
  OPT_frounding_math = 889,                  /* -frounding-math */
  OPT_frtti = 890,                           /* -frtti */
  OPT_fsanitize_coverage_trace_pc = 891,     /* -fsanitize-coverage=trace-pc */
  OPT_fsanitize_ = 892,                      /* -fsanitize= */
  OPT_fsaw_java_file = 893,                  /* -fsaw-java-file */
  OPT_fsched_critical_path_heuristic = 894,  /* -fsched-critical-path-heuristic */
  OPT_fsched_dep_count_heuristic = 895,      /* -fsched-dep-count-heuristic */
  OPT_fsched_group_heuristic = 896,          /* -fsched-group-heuristic */
  OPT_fsched_interblock = 897,               /* -fsched-interblock */
  OPT_fsched_last_insn_heuristic = 898,      /* -fsched-last-insn-heuristic */
  OPT_fsched_pressure = 899,                 /* -fsched-pressure */
  OPT_fsched_rank_heuristic = 900,           /* -fsched-rank-heuristic */
  OPT_fsched_spec = 901,                     /* -fsched-spec */
  OPT_fsched_spec_insn_heuristic = 902,      /* -fsched-spec-insn-heuristic */
  OPT_fsched_spec_load = 903,                /* -fsched-spec-load */
  OPT_fsched_spec_load_dangerous = 904,      /* -fsched-spec-load-dangerous */
  OPT_fsched_stalled_insns = 905,            /* -fsched-stalled-insns */
  OPT_fsched_stalled_insns_dep = 906,        /* -fsched-stalled-insns-dep */
  OPT_fsched_stalled_insns_dep_ = 907,       /* -fsched-stalled-insns-dep= */
  OPT_fsched_stalled_insns_ = 908,           /* -fsched-stalled-insns= */
  OPT_fsched_verbose_ = 909,                 /* -fsched-verbose= */
  OPT_fsched2_use_superblocks = 910,         /* -fsched2-use-superblocks */
  /* OPT_fsched2_use_traces = 911, */        /* -fsched2-use-traces */
  OPT_fschedule_insns = 912,                 /* -fschedule-insns */
  OPT_fschedule_insns2 = 913,                /* -fschedule-insns2 */
  OPT_fsecond_underscore = 914,              /* -fsecond-underscore */
  OPT_fsection_anchors = 915,                /* -fsection-anchors */
  /* OPT_fsee = 916, */                      /* -fsee */
  OPT_fsel_sched_pipelining = 917,           /* -fsel-sched-pipelining */
  OPT_fsel_sched_pipelining_outer_loops = 918,/* -fsel-sched-pipelining-outer-loops */
  OPT_fsel_sched_reschedule_pipelined = 919, /* -fsel-sched-reschedule-pipelined */
  OPT_fselective_scheduling = 920,           /* -fselective-scheduling */
  OPT_fselective_scheduling2 = 921,          /* -fselective-scheduling2 */
  OPT_fshort_double = 922,                   /* -fshort-double */
  OPT_fshort_enums = 923,                    /* -fshort-enums */
  OPT_fshort_wchar = 924,                    /* -fshort-wchar */
  OPT_fshow_column = 925,                    /* -fshow-column */
  OPT_fshrink_wrap = 926,                    /* -fshrink-wrap */
  OPT_fshrink_wrap_frame_pointer = 927,      /* -fshrink-wrap-frame-pointer */
  OPT_fsign_zero = 928,                      /* -fsign-zero */
  OPT_fsignaling_nans = 929,                 /* -fsignaling-nans */
  OPT_fsigned_bitfields = 930,               /* -fsigned-bitfields */
  OPT_fsigned_char = 931,                    /* -fsigned-char */
  OPT_fsigned_zeros = 932,                   /* -fsigned-zeros */
  OPT_fsimd_cost_model_ = 933,               /* -fsimd-cost-model= */
  OPT_fsingle_precision_constant = 934,      /* -fsingle-precision-constant */
  OPT_fsized_delete = 935,                   /* -fsized-delete */
  OPT_fsource_filename_ = 936,               /* -fsource-filename= */
  OPT_fsource_ = 937,                        /* -fsource= */
  OPT_fsplit_ivs_in_unroller = 938,          /* -fsplit-ivs-in-unroller */
  OPT_fsplit_stack = 939,                    /* -fsplit-stack */
  OPT_fsplit_wide_types = 940,               /* -fsplit-wide-types */
  /* OPT_fsquangle = 941, */                 /* -fsquangle */
  OPT_fstack_arrays = 942,                   /* -fstack-arrays */
  /* OPT_fstack_check = 943, */              /* -fstack-check */
  OPT_fstack_check_ = 944,                   /* -fstack-check= */
  OPT_fstack_limit = 945,                    /* -fstack-limit */
  OPT_fstack_limit_register_ = 946,          /* -fstack-limit-register= */
  OPT_fstack_limit_symbol_ = 947,            /* -fstack-limit-symbol= */
  OPT_fstack_protector = 948,                /* -fstack-protector */
  OPT_fstack_protector_all = 949,            /* -fstack-protector-all */
  OPT_fstack_protector_strong = 950,         /* -fstack-protector-strong */
  OPT_fstack_reuse_ = 951,                   /* -fstack-reuse= */
  OPT_fstack_usage = 952,                    /* -fstack-usage */
  OPT_fstats = 953,                          /* -fstats */
  OPT_fstore_check = 954,                    /* -fstore-check */
  /* OPT_fstrength_reduce = 955, */          /* -fstrength-reduce */
  OPT_fstrict_aliasing = 956,                /* -fstrict-aliasing */
  OPT_fstrict_enum_precision = 957,          /* -fstrict-enum-precision */
  OPT_fstrict_enums = 958,                   /* -fstrict-enums */
  OPT_fstrict_overflow = 959,                /* -fstrict-overflow */
  /* OPT_fstrict_prototype = 960, */         /* -fstrict-prototype */
  OPT_fstrict_volatile_bitfields = 961,      /* -fstrict-volatile-bitfields */
  OPT_fsync_libcalls = 962,                  /* -fsync-libcalls */
  OPT_fsyntax_only = 963,                    /* -fsyntax-only */
  OPT_ftabstop_ = 964,                       /* -ftabstop= */
  /* OPT_ftarget_help = 965, */              /* -ftarget-help */
  OPT_ftarget_ = 966,                        /* -ftarget= */
  OPT_ftemplate_backtrace_limit_ = 967,      /* -ftemplate-backtrace-limit= */
  /* OPT_ftemplate_depth_ = 968, */          /* -ftemplate-depth- */
  OPT_ftemplate_depth_ = 969,                /* -ftemplate-depth= */
  OPT_ftest_coverage = 970,                  /* -ftest-coverage */
  /* OPT_fthis_is_variable = 971, */         /* -fthis-is-variable */
  OPT_fthread_jumps = 972,                   /* -fthread-jumps */
  OPT_fthreadsafe_statics = 973,             /* -fthreadsafe-statics */
  OPT_ftime_report = 974,                    /* -ftime-report */
  OPT_ftls_model_ = 975,                     /* -ftls-model= */
  OPT_ftoplevel_reorder = 976,               /* -ftoplevel-reorder */
  OPT_ftracer = 977,                         /* -ftracer */
  OPT_ftrack_macro_expansion = 978,          /* -ftrack-macro-expansion */
  OPT_ftrack_macro_expansion_ = 979,         /* -ftrack-macro-expansion= */
  OPT_ftrapping_math = 980,                  /* -ftrapping-math */
  OPT_ftrapv = 981,                          /* -ftrapv */
  OPT_ftree_bit_ccp = 982,                   /* -ftree-bit-ccp */
  OPT_ftree_builtin_call_dce = 983,          /* -ftree-builtin-call-dce */
  OPT_ftree_ccp = 984,                       /* -ftree-ccp */
  OPT_ftree_ch = 985,                        /* -ftree-ch */
  OPT_ftree_coalesce_inlined_vars = 986,     /* -ftree-coalesce-inlined-vars */
  OPT_ftree_coalesce_vars = 987,             /* -ftree-coalesce-vars */
  OPT_ftree_copy_prop = 988,                 /* -ftree-copy-prop */
  OPT_ftree_copyrename = 989,                /* -ftree-copyrename */
  OPT_ftree_cselim = 990,                    /* -ftree-cselim */
  OPT_ftree_dce = 991,                       /* -ftree-dce */
  OPT_ftree_dominator_opts = 992,            /* -ftree-dominator-opts */
  OPT_ftree_dse = 993,                       /* -ftree-dse */
  OPT_ftree_forwprop = 994,                  /* -ftree-forwprop */
  OPT_ftree_fre = 995,                       /* -ftree-fre */
  OPT_ftree_loop_distribute_patterns = 996,  /* -ftree-loop-distribute-patterns */
  OPT_ftree_loop_distribution = 997,         /* -ftree-loop-distribution */
  OPT_ftree_loop_if_convert = 998,           /* -ftree-loop-if-convert */
  OPT_ftree_loop_if_convert_stores = 999,    /* -ftree-loop-if-convert-stores */
  OPT_ftree_loop_im = 1000,                  /* -ftree-loop-im */
  OPT_ftree_loop_ivcanon = 1001,             /* -ftree-loop-ivcanon */
  /* OPT_ftree_loop_linear = 1002, */        /* -ftree-loop-linear */
  OPT_ftree_loop_optimize = 1003,            /* -ftree-loop-optimize */
  OPT_ftree_loop_vectorize = 1004,           /* -ftree-loop-vectorize */
  OPT_ftree_lrs = 1005,                      /* -ftree-lrs */
  OPT_ftree_parallelize_loops_ = 1006,       /* -ftree-parallelize-loops= */
  OPT_ftree_partial_pre = 1007,              /* -ftree-partial-pre */
  OPT_ftree_phiprop = 1008,                  /* -ftree-phiprop */
  OPT_ftree_pre = 1009,                      /* -ftree-pre */
  OPT_ftree_pta = 1010,                      /* -ftree-pta */
  OPT_ftree_reassoc = 1011,                  /* -ftree-reassoc */
  /* OPT_ftree_salias = 1012, */             /* -ftree-salias */
  OPT_ftree_scev_cprop = 1013,               /* -ftree-scev-cprop */
  OPT_ftree_sink = 1014,                     /* -ftree-sink */
  OPT_ftree_slp_vectorize = 1015,            /* -ftree-slp-vectorize */
  OPT_ftree_slsr = 1016,                     /* -ftree-slsr */
  OPT_ftree_sra = 1017,                      /* -ftree-sra */
  /* OPT_ftree_store_ccp = 1018, */          /* -ftree-store-ccp */
  /* OPT_ftree_store_copy_prop = 1019, */    /* -ftree-store-copy-prop */
  OPT_ftree_switch_conversion = 1020,        /* -ftree-switch-conversion */
  OPT_ftree_tail_merge = 1021,               /* -ftree-tail-merge */
  OPT_ftree_ter = 1022,                      /* -ftree-ter */
  /* OPT_ftree_vect_loop_version = 1023, */  /* -ftree-vect-loop-version */
  OPT_ftree_vectorize = 1024,                /* -ftree-vectorize */
  /* OPT_ftree_vectorizer_verbose_ = 1025, *//* -ftree-vectorizer-verbose= */
  OPT_ftree_vrp = 1026,                      /* -ftree-vrp */
  OPT_ftwo_level_all_subprogs = 1027,        /* -ftwo-level-all-subprogs */
  OPT_ftwo_level_line_tables = 1028,         /* -ftwo-level-line-tables */
  OPT_funderscoring = 1029,                  /* -funderscoring */
  OPT_funit_at_a_time = 1030,                /* -funit-at-a-time */
  OPT_funroll_all_loops = 1031,              /* -funroll-all-loops */
  OPT_funroll_codesize_limit = 1032,         /* -funroll-codesize-limit */
  OPT_funroll_loops = 1033,                  /* -funroll-loops */
  OPT_funsafe_loop_optimizations = 1034,     /* -funsafe-loop-optimizations */
  OPT_funsafe_math_optimizations = 1035,     /* -funsafe-math-optimizations */
  OPT_funsigned_bitfields = 1036,            /* -funsigned-bitfields */
  OPT_funsigned_char = 1037,                 /* -funsigned-char */
  OPT_funswitch_loops = 1038,                /* -funswitch-loops */
  OPT_funwind_tables = 1039,                 /* -funwind-tables */
  OPT_fuse_atomic_builtins = 1040,           /* -fuse-atomic-builtins */
  OPT_fuse_boehm_gc = 1041,                  /* -fuse-boehm-gc */
  OPT_fuse_cxa_atexit = 1042,                /* -fuse-cxa-atexit */
  OPT_fuse_cxa_get_exception_ptr = 1043,     /* -fuse-cxa-get-exception-ptr */
  OPT_fuse_divide_subroutine = 1044,         /* -fuse-divide-subroutine */
  OPT_fuse_ld_bfd = 1045,                    /* -fuse-ld=bfd */
  OPT_fuse_ld_gold = 1046,                   /* -fuse-ld=gold */
  OPT_fuse_ld_mcld = 1047,                   /* -fuse-ld=mcld */
  OPT_fuse_linker_plugin = 1048,             /* -fuse-linker-plugin */
  OPT_fvar_tracking = 1049,                  /* -fvar-tracking */
  OPT_fvar_tracking_assignments = 1050,      /* -fvar-tracking-assignments */
  OPT_fvar_tracking_assignments_toggle = 1051,/* -fvar-tracking-assignments-toggle */
  OPT_fvar_tracking_uninit = 1052,           /* -fvar-tracking-uninit */
  OPT_fvariable_expansion_in_unroller = 1053,/* -fvariable-expansion-in-unroller */
  /* OPT_fvect_cost_model = 1054, */         /* -fvect-cost-model */
  OPT_fvect_cost_model_ = 1055,              /* -fvect-cost-model= */
  OPT_fverbose_asm = 1056,                   /* -fverbose-asm */
  /* OPT_fversion = 1057, */                 /* -fversion */
  OPT_fvisibility_inlines_hidden = 1058,     /* -fvisibility-inlines-hidden */
  OPT_fvisibility_ms_compat = 1059,          /* -fvisibility-ms-compat */
  OPT_fvisibility_ = 1060,                   /* -fvisibility= */
  OPT_fvpt = 1061,                           /* -fvpt */
  /* OPT_fvtable_gc = 1062, */               /* -fvtable-gc */
  /* OPT_fvtable_thunks = 1063, */           /* -fvtable-thunks */
  OPT_fvtable_verify_ = 1064,                /* -fvtable-verify= */
  OPT_fvtv_counts = 1065,                    /* -fvtv-counts */
  OPT_fvtv_debug = 1066,                     /* -fvtv-debug */
  OPT_fweak = 1067,                          /* -fweak */
  OPT_fweb = 1068,                           /* -fweb */
  /* OPT_fwhole_file = 1069, */              /* -fwhole-file */
  OPT_fwhole_program = 1070,                 /* -fwhole-program */
  OPT_fwide_exec_charset_ = 1071,            /* -fwide-exec-charset= */
  OPT_fworking_directory = 1072,             /* -fworking-directory */
  OPT_fwpa = 1073,                           /* -fwpa */
  OPT_fwpa_ = 1074,                          /* -fwpa= */
  OPT_fwrapv = 1075,                         /* -fwrapv */
  /* OPT_fxref = 1076, */                    /* -fxref */
  /* OPT_fzee = 1077, */                     /* -fzee */
  OPT_fzero_initialized_in_bss = 1078,       /* -fzero-initialized-in-bss */
  OPT_fzero_link = 1079,                     /* -fzero-link */
  OPT_g = 1080,                              /* -g */
  OPT_gant = 1081,                           /* -gant */
  OPT_gcoff = 1082,                          /* -gcoff */
  OPT_gdwarf = 1083,                         /* -gdwarf */
  OPT_gdwarf_ = 1084,                        /* -gdwarf- */
  OPT_gen_decls = 1085,                      /* -gen-decls */
  /* OPT_gfission = 1086, */                 /* -gfission */
  OPT_ggdb = 1087,                           /* -ggdb */
  OPT_ggnu_pubnames = 1088,                  /* -ggnu-pubnames */
  OPT_gline_tables_only = 1089,              /* -gline-tables-only */
  OPT_gmlt = 1090,                           /* -gmlt */
  OPT_gnat = 1091,                           /* -gnat */
  OPT_gnatO = 1092,                          /* -gnatO */
  /* OPT_gno_fission = 1093, */              /* -gno-fission */
  OPT_gno_pubnames = 1094,                   /* -gno-pubnames */
  OPT_gno_record_gcc_switches = 1095,        /* -gno-record-gcc-switches */
  OPT_gno_split_dwarf = 1096,                /* -gno-split-dwarf */
  OPT_gno_strict_dwarf = 1097,               /* -gno-strict-dwarf */
  OPT_gpubnames = 1098,                      /* -gpubnames */
  OPT_grecord_gcc_switches = 1099,           /* -grecord-gcc-switches */
  OPT_gsplit_dwarf = 1100,                   /* -gsplit-dwarf */
  OPT_gstabs = 1101,                         /* -gstabs */
  OPT_gstabs_ = 1102,                        /* -gstabs+ */
  OPT_gstrict_dwarf = 1103,                  /* -gstrict-dwarf */
  OPT_gtoggle = 1104,                        /* -gtoggle */
  OPT_gvms = 1105,                           /* -gvms */
  OPT_gxcoff = 1106,                         /* -gxcoff */
  OPT_gxcoff_ = 1107,                        /* -gxcoff+ */
  OPT_h = 1108,                              /* -h */
  OPT_idirafter = 1109,                      /* -idirafter */
  OPT_imacros = 1110,                        /* -imacros */
  OPT_imultiarch = 1111,                     /* -imultiarch */
  OPT_imultilib = 1112,                      /* -imultilib */
  OPT_include = 1113,                        /* -include */
  OPT_iplugindir_ = 1114,                    /* -iplugindir= */
  OPT_iprefix = 1115,                        /* -iprefix */
  OPT_iquote = 1116,                         /* -iquote */
  OPT_isysroot = 1117,                       /* -isysroot */
  OPT_isystem = 1118,                        /* -isystem */
  OPT_iwithprefix = 1119,                    /* -iwithprefix */
  OPT_iwithprefixbefore = 1120,              /* -iwithprefixbefore */
  OPT_k8 = 1121,                             /* -k8 */
  OPT_l = 1122,                              /* -l */
  OPT_lang_asm = 1123,                       /* -lang-asm */
  OPT_m128bit_long_double = 1124,            /* -m128bit-long-double */
  OPT_m16 = 1125,                            /* -m16 */
  OPT_m32 = 1126,                            /* -m32 */
  OPT_m3dnow = 1127,                         /* -m3dnow */
  OPT_m3dnowa = 1128,                        /* -m3dnowa */
  OPT_m64 = 1129,                            /* -m64 */
  OPT_m80387 = 1130,                         /* -m80387 */
  OPT_m8bit_idiv = 1131,                     /* -m8bit-idiv */
  OPT_m96bit_long_double = 1132,             /* -m96bit-long-double */
  OPT_mabi_ = 1133,                          /* -mabi= */
  OPT_mabm = 1134,                           /* -mabm */
  OPT_maccumulate_outgoing_args = 1135,      /* -maccumulate-outgoing-args */
  OPT_maddress_mode_ = 1136,                 /* -maddress-mode= */
  OPT_madx = 1137,                           /* -madx */
  OPT_maes = 1138,                           /* -maes */
  OPT_malign_double = 1139,                  /* -malign-double */
  OPT_malign_functions_ = 1140,              /* -malign-functions= */
  OPT_malign_jumps_ = 1141,                  /* -malign-jumps= */
  OPT_malign_loops_ = 1142,                  /* -malign-loops= */
  OPT_malign_stringops = 1143,               /* -malign-stringops */
  OPT_mandroid = 1144,                       /* -mandroid */
  OPT_march_ = 1145,                         /* -march= */
  OPT_masm_ = 1146,                          /* -masm= */
  OPT_mavx = 1147,                           /* -mavx */
  OPT_mavx2 = 1148,                          /* -mavx2 */
  OPT_mavx256_split_unaligned_load = 1149,   /* -mavx256-split-unaligned-load */
  OPT_mavx256_split_unaligned_store = 1150,  /* -mavx256-split-unaligned-store */
  OPT_mavx512cd = 1151,                      /* -mavx512cd */
  OPT_mavx512er = 1152,                      /* -mavx512er */
  OPT_mavx512f = 1153,                       /* -mavx512f */
  OPT_mavx512pf = 1154,                      /* -mavx512pf */
  OPT_mbionic = 1155,                        /* -mbionic */
  OPT_mbmi = 1156,                           /* -mbmi */
  OPT_mbmi2 = 1157,                          /* -mbmi2 */
  OPT_mbranch_cost_ = 1158,                  /* -mbranch-cost= */
  OPT_mcld = 1159,                           /* -mcld */
  OPT_mcmodel_ = 1160,                       /* -mcmodel= */
  /* OPT_mcpu_ = 1161, */                    /* -mcpu= */
  OPT_mcrc32 = 1162,                         /* -mcrc32 */
  OPT_mcx16 = 1163,                          /* -mcx16 */
  OPT_mdispatch_scheduler = 1164,            /* -mdispatch-scheduler */
  OPT_mdump_tune_features = 1165,            /* -mdump-tune-features */
  OPT_mf16c = 1166,                          /* -mf16c */
  OPT_mfancy_math_387 = 1167,                /* -mfancy-math-387 */
  OPT_mfentry = 1168,                        /* -mfentry */
  OPT_mfma = 1169,                           /* -mfma */
  OPT_mfma4 = 1170,                          /* -mfma4 */
  OPT_mforce_drap = 1171,                    /* -mforce-drap */
  OPT_mfp_ret_in_387 = 1172,                 /* -mfp-ret-in-387 */
  OPT_mfpmath_ = 1173,                       /* -mfpmath= */
  OPT_mfsgsbase = 1174,                      /* -mfsgsbase */
  OPT_mfunction_return_ = 1175,              /* -mfunction-return= */
  /* OPT_mfused_madd = 1176, */              /* -mfused-madd */
  OPT_mfxsr = 1177,                          /* -mfxsr */
  OPT_mglibc = 1178,                         /* -mglibc */
  OPT_mhard_float = 1179,                    /* -mhard-float */
  OPT_mhle = 1180,                           /* -mhle */
  OPT_mieee_fp = 1181,                       /* -mieee-fp */
  OPT_mincoming_stack_boundary_ = 1182,      /* -mincoming-stack-boundary= */
  OPT_mindirect_branch_register = 1183,      /* -mindirect-branch-register */
  OPT_mindirect_branch_ = 1184,              /* -mindirect-branch= */
  OPT_minline_all_stringops = 1185,          /* -minline-all-stringops */
  OPT_minline_stringops_dynamically = 1186,  /* -minline-stringops-dynamically */
  /* OPT_mintel_syntax = 1187, */            /* -mintel-syntax */
  OPT_mlarge_data_threshold_ = 1188,         /* -mlarge-data-threshold= */
  OPT_mlong_double_128 = 1189,               /* -mlong-double-128 */
  OPT_mlong_double_64 = 1190,                /* -mlong-double-64 */
  OPT_mlong_double_80 = 1191,                /* -mlong-double-80 */
  OPT_mlwp = 1192,                           /* -mlwp */
  OPT_mlzcnt = 1193,                         /* -mlzcnt */
  OPT_mmemcpy_strategy_ = 1194,              /* -mmemcpy-strategy= */
  OPT_mmemset_strategy_ = 1195,              /* -mmemset-strategy= */
  OPT_mmmx = 1196,                           /* -mmmx */
  OPT_mmovbe = 1197,                         /* -mmovbe */
  OPT_mms_bitfields = 1198,                  /* -mms-bitfields */
  OPT_mno_align_stringops = 1199,            /* -mno-align-stringops */
  OPT_mno_default = 1200,                    /* -mno-default */
  OPT_mno_fancy_math_387 = 1201,             /* -mno-fancy-math-387 */
  OPT_mno_push_args = 1202,                  /* -mno-push-args */
  OPT_mno_red_zone = 1203,                   /* -mno-red-zone */
  OPT_mno_sse4 = 1204,                       /* -mno-sse4 */
  OPT_momit_leaf_frame_pointer = 1205,       /* -momit-leaf-frame-pointer */
  OPT_mpc32 = 1206,                          /* -mpc32 */
  OPT_mpc64 = 1207,                          /* -mpc64 */
  OPT_mpc80 = 1208,                          /* -mpc80 */
  OPT_mpclmul = 1209,                        /* -mpclmul */
  OPT_mpopcnt = 1210,                        /* -mpopcnt */
  OPT_mprefer_avx128 = 1211,                 /* -mprefer-avx128 */
  OPT_mpreferred_stack_boundary_ = 1212,     /* -mpreferred-stack-boundary= */
  OPT_mprefetchwt1 = 1213,                   /* -mprefetchwt1 */
  OPT_mprfchw = 1214,                        /* -mprfchw */
  OPT_mpush_args = 1215,                     /* -mpush-args */
  OPT_mrdrnd = 1216,                         /* -mrdrnd */
  OPT_mrdseed = 1217,                        /* -mrdseed */
  OPT_mrecip = 1218,                         /* -mrecip */
  OPT_mrecip_ = 1219,                        /* -mrecip= */
  OPT_mred_zone = 1220,                      /* -mred-zone */
  OPT_mregparm_ = 1221,                      /* -mregparm= */
  OPT_mrtd = 1222,                           /* -mrtd */
  OPT_mrtm = 1223,                           /* -mrtm */
  OPT_msahf = 1224,                          /* -msahf */
  OPT_msha = 1225,                           /* -msha */
  OPT_msoft_float = 1226,                    /* -msoft-float */
  OPT_msse = 1227,                           /* -msse */
  OPT_msse2 = 1228,                          /* -msse2 */
  OPT_msse2avx = 1229,                       /* -msse2avx */
  OPT_msse3 = 1230,                          /* -msse3 */
  OPT_msse4 = 1231,                          /* -msse4 */
  OPT_msse4_1 = 1232,                        /* -msse4.1 */
  OPT_msse4_2 = 1233,                        /* -msse4.2 */
  OPT_msse4a = 1234,                         /* -msse4a */
  /* OPT_msse5 = 1235, */                    /* -msse5 */
  OPT_msseregparm = 1236,                    /* -msseregparm */
  OPT_mssse3 = 1237,                         /* -mssse3 */
  OPT_mstack_arg_probe = 1238,               /* -mstack-arg-probe */
  OPT_mstack_protector_guard_ = 1239,        /* -mstack-protector-guard= */
  OPT_mstackrealign = 1240,                  /* -mstackrealign */
  OPT_mstringop_strategy_ = 1241,            /* -mstringop-strategy= */
  OPT_mtbm = 1242,                           /* -mtbm */
  OPT_mtls_dialect_ = 1243,                  /* -mtls-dialect= */
  OPT_mtls_direct_seg_refs = 1244,           /* -mtls-direct-seg-refs */
  OPT_mtune_ctrl_ = 1245,                    /* -mtune-ctrl= */
  OPT_mtune_ = 1246,                         /* -mtune= */
  OPT_muclibc = 1247,                        /* -muclibc */
  OPT_mveclibabi_ = 1248,                    /* -mveclibabi= */
  OPT_mvect8_ret_in_mem = 1249,              /* -mvect8-ret-in-mem */
  OPT_mvzeroupper = 1250,                    /* -mvzeroupper */
  OPT_mx32 = 1251,                           /* -mx32 */
  OPT_mxop = 1252,                           /* -mxop */
  OPT_mxsave = 1253,                         /* -mxsave */
  OPT_mxsaveopt = 1254,                      /* -mxsaveopt */
  OPT_n = 1255,                              /* -n */
  OPT_no_canonical_prefixes = 1256,          /* -no-canonical-prefixes */
  OPT_no_integrated_cpp = 1257,              /* -no-integrated-cpp */
  OPT_no_pie = 1258,                         /* -no-pie */
  OPT_nocpp = 1259,                          /* -nocpp */
  OPT_nodefaultlibs = 1260,                  /* -nodefaultlibs */
  OPT_nostartfiles = 1261,                   /* -nostartfiles */
  OPT_nostdinc = 1262,                       /* -nostdinc */
  OPT_nostdinc__ = 1263,                     /* -nostdinc++ */
  OPT_nostdlib = 1264,                       /* -nostdlib */
  OPT_o = 1265,                              /* -o */
  OPT_p = 1266,                              /* -p */
  OPT_pass_exit_codes = 1267,                /* -pass-exit-codes */
  /* OPT_pedantic = 1268, */                 /* -pedantic */
  OPT_pedantic_errors = 1269,                /* -pedantic-errors */
  OPT_pg = 1270,                             /* -pg */
  OPT_pie = 1271,                            /* -pie */
  OPT_pipe = 1272,                           /* -pipe */
  OPT_posix = 1273,                          /* -posix */
  OPT_print_file_name_ = 1274,               /* -print-file-name= */
  OPT_print_libgcc_file_name = 1275,         /* -print-libgcc-file-name */
  OPT_print_multi_directory = 1276,          /* -print-multi-directory */
  OPT_print_multi_lib = 1277,                /* -print-multi-lib */
  OPT_print_multi_os_directory = 1278,       /* -print-multi-os-directory */
  OPT_print_multiarch = 1279,                /* -print-multiarch */
  OPT_print_objc_runtime_info = 1280,        /* -print-objc-runtime-info */
  OPT_print_prog_name_ = 1281,               /* -print-prog-name= */
  OPT_print_search_dirs = 1282,              /* -print-search-dirs */
  OPT_print_sysroot = 1283,                  /* -print-sysroot */
  OPT_print_sysroot_headers_suffix = 1284,   /* -print-sysroot-headers-suffix */
  OPT_profile = 1285,                        /* -profile */
  OPT_pthread = 1286,                        /* -pthread */
  OPT_quiet = 1287,                          /* -quiet */
  OPT_r = 1288,                              /* -r */
  OPT_rdynamic = 1289,                       /* -rdynamic */
  OPT_remap = 1290,                          /* -remap */
  OPT_s = 1291,                              /* -s */
  OPT_s_bc_abi = 1292,                       /* -s-bc-abi */
  OPT_save_temps = 1293,                     /* -save-temps */
  OPT_save_temps_ = 1294,                    /* -save-temps= */
  OPT_shared = 1295,                         /* -shared */
  OPT_shared_libgcc = 1296,                  /* -shared-libgcc */
  /* OPT_specs = 1297, */                    /* -specs */
  OPT_specs_ = 1298,                         /* -specs= */
  OPT_static = 1299,                         /* -static */
  OPT_static_libasan = 1300,                 /* -static-libasan */
  OPT_static_libgcc = 1301,                  /* -static-libgcc */
  OPT_static_libgcj = 1302,                  /* -static-libgcj */
  OPT_static_libgfortran = 1303,             /* -static-libgfortran */
  OPT_static_libgo = 1304,                   /* -static-libgo */
  OPT_static_liblsan = 1305,                 /* -static-liblsan */
  OPT_static_libstdc__ = 1306,               /* -static-libstdc++ */
  OPT_static_libtsan = 1307,                 /* -static-libtsan */
  OPT_static_libubsan = 1308,                /* -static-libubsan */
  /* OPT_std_c__03 = 1309, */                /* -std=c++03 */
  /* OPT_std_c__0x = 1310, */                /* -std=c++0x */
  OPT_std_c__11 = 1311,                      /* -std=c++11 */
  /* OPT_std_c__14 = 1312, */                /* -std=c++14 */
  OPT_std_c__1y = 1313,                      /* -std=c++1y */
  ...
  OPT_std_gnu__1y = 1330,                    /* -std=gnu++1y */
  OPT_std_gnu__98 = 1331,                    /* -std=gnu++98 */
  OPT_std_gnu11 = 1332,                      /* -std=gnu11 */
  /* OPT_std_gnu1x = 1333, */                /* -std=gnu1x */
  /* OPT_std_gnu89 = 1334, */                /* -std=gnu89 */
  OPT_std_gnu90 = 1335,                      /* -std=gnu90 */
  OPT_std_gnu99 = 1336,                      /* -std=gnu99 */
  /* OPT_std_gnu9x = 1337, */                /* -std=gnu9x */
  /* OPT_std_iso9899_1990 = 1338, */         /* -std=iso9899:1990 */
  OPT_std_iso9899_199409 = 1339,             /* -std=iso9899:199409 */
  /* OPT_std_iso9899_1999 = 1340, */         /* -std=iso9899:1999 */
  /* OPT_std_iso9899_199x = 1341, */         /* -std=iso9899:199x */
  /* OPT_std_iso9899_2011 = 1342, */         /* -std=iso9899:2011 */
  OPT_std_legacy = 1343,                     /* -std=legacy */
  OPT_symbolic = 1344,                       /* -symbolic */
  OPT_t = 1345,                              /* -t */
  OPT_time = 1346,                           /* -time */
  OPT_time_ = 1347,                          /* -time= */
  OPT_tno_android_cc = 1348,                 /* -tno-android-cc */
  OPT_tno_android_ld = 1349,                 /* -tno-android-ld */
  OPT_traditional = 1350,                    /* -traditional */
  OPT_traditional_cpp = 1351,                /* -traditional-cpp */
  OPT_trigraphs = 1352,                      /* -trigraphs */
  OPT_u = 1353,                              /* -u */
  OPT_undef = 1354,                          /* -undef */
  OPT_v = 1355,                              /* -v */
  OPT_version = 1356,                        /* -version */
  OPT_w = 1357,                              /* -w */
  OPT_wrapper = 1358,                        /* -wrapper */
  OPT_x = 1359,                              /* -x */
  OPT_z = 1360,                              /* -z */
  N_OPTS,
  OPT_SPECIAL_unknown,
