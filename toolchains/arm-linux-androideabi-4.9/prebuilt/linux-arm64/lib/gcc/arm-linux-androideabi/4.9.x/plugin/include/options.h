...
enum opt_code
{
  ...
  OPT_mabi_ = 1124,                          /* -mabi= */
  OPT_mabort_on_noreturn = 1125,             /* -mabort-on-noreturn */
  OPT_mandroid = 1126,                       /* -mandroid */
  OPT_mapcs = 1127,                          /* -mapcs */
  OPT_mapcs_float = 1128,                    /* -mapcs-float */
  OPT_mapcs_frame = 1129,                    /* -mapcs-frame */
  OPT_mapcs_reentrant = 1130,                /* -mapcs-reentrant */
  OPT_mapcs_stack_check = 1131,              /* -mapcs-stack-check */
  OPT_march_ = 1132,                         /* -march= */
  OPT_marm = 1133,                           /* -marm */
  OPT_mbig_endian = 1134,                    /* -mbig-endian */
  OPT_mbionic = 1135,                        /* -mbionic */
  OPT_mcallee_super_interworking = 1136,     /* -mcallee-super-interworking */
  OPT_mcaller_super_interworking = 1137,     /* -mcaller-super-interworking */
  OPT_mcpu_ = 1138,                          /* -mcpu= */
  OPT_mfix_cortex_m3_ldrd = 1139,            /* -mfix-cortex-m3-ldrd */
  OPT_mfloat_abi_ = 1140,                    /* -mfloat-abi= */
  OPT_mfp16_format_ = 1141,                  /* -mfp16-format= */
  OPT_mfpu_ = 1142,                          /* -mfpu= */
  OPT_mglibc = 1143,                         /* -mglibc */
  /* OPT_mhard_float = 1144, */              /* -mhard-float */
  OPT_minline_thumb1_jumptable = 1145,       /* -minline-thumb1-jumptable */
  OPT_mlittle_endian = 1146,                 /* -mlittle-endian */
  OPT_mlong_calls = 1147,                    /* -mlong-calls */
  OPT_mlra = 1148,                           /* -mlra */
  OPT_mneon_for_64bits = 1149,               /* -mneon-for-64bits */
  OPT_mnew_generic_costs = 1150,             /* -mnew-generic-costs */
  OPT_mold_rtx_costs = 1151,                 /* -mold-rtx-costs */
  OPT_mpic_data_is_text_relative = 1152,     /* -mpic-data-is-text-relative */
  OPT_mpic_register_ = 1153,                 /* -mpic-register= */
  OPT_mpoke_function_name = 1154,            /* -mpoke-function-name */
  OPT_mrestrict_it = 1155,                   /* -mrestrict-it */
  OPT_msched_prolog = 1156,                  /* -msched-prolog */
  OPT_msingle_pic_base = 1157,               /* -msingle-pic-base */
  OPT_mslow_flash_data = 1158,               /* -mslow-flash-data */
  /* OPT_msoft_float = 1159, */              /* -msoft-float */
  OPT_mstructure_size_boundary_ = 1160,      /* -mstructure-size-boundary= */
  OPT_mthumb = 1161,                         /* -mthumb */
  OPT_mthumb_interwork = 1162,               /* -mthumb-interwork */
  OPT_mtls_dialect_ = 1163,                  /* -mtls-dialect= */
  OPT_mtp_ = 1164,                           /* -mtp= */
  OPT_mtpcs_frame = 1165,                    /* -mtpcs-frame */
  OPT_mtpcs_leaf_frame = 1166,               /* -mtpcs-leaf-frame */
  OPT_mtune_ = 1167,                         /* -mtune= */
  OPT_muclibc = 1168,                        /* -muclibc */
  OPT_munaligned_access = 1169,              /* -munaligned-access */
  OPT_mvectorize_with_neon_double = 1170,    /* -mvectorize-with-neon-double */
  OPT_mvectorize_with_neon_quad = 1171,      /* -mvectorize-with-neon-quad */
  OPT_mword_relocations = 1172,              /* -mword-relocations */
  OPT_mwords_little_endian = 1173,           /* -mwords-little-endian */
  OPT_n = 1174,                              /* -n */
  ...
  OPT_nostartfiles = 1180,                   /* -nostartfiles */
  OPT_nostdinc = 1181,                       /* -nostdinc */
  OPT_nostdinc__ = 1182,                     /* -nostdinc++ */
  OPT_nostdlib = 1183,                       /* -nostdlib */
  OPT_o = 1184,                              /* -o */
  OPT_p = 1185,                              /* -p */
  OPT_pass_exit_codes = 1186,                /* -pass-exit-codes */
  /* OPT_pedantic = 1187, */                 /* -pedantic */
  OPT_pedantic_errors = 1188,                /* -pedantic-errors */
  OPT_pg = 1189,                             /* -pg */
  OPT_pie = 1190,                            /* -pie */
  OPT_pipe = 1191,                           /* -pipe */
  OPT_posix = 1192,                          /* -posix */
  ...
  OPT_profile = 1204,                        /* -profile */
  OPT_pthread = 1205,                        /* -pthread */
  OPT_quiet = 1206,                          /* -quiet */
  OPT_r = 1207,                              /* -r */
  OPT_rdynamic = 1208,                       /* -rdynamic */
  OPT_remap = 1209,                          /* -remap */
  OPT_s = 1210,                              /* -s */
  OPT_s_bc_abi = 1211,                       /* -s-bc-abi */
  ...
  OPT_static_libgcj = 1221,                  /* -static-libgcj */
  OPT_static_libgfortran = 1222,             /* -static-libgfortran */
  OPT_static_libgo = 1223,                   /* -static-libgo */
  OPT_static_liblsan = 1224,                 /* -static-liblsan */
  OPT_static_libstdc__ = 1225,               /* -static-libstdc++ */
  OPT_static_libtsan = 1226,                 /* -static-libtsan */
  OPT_static_libubsan = 1227,                /* -static-libubsan */
  /* OPT_std_c__03 = 1228, */                /* -std=c++03 */
  /* OPT_std_c__0x = 1229, */                /* -std=c++0x */
  OPT_std_c__11 = 1230,                      /* -std=c++11 */
  /* OPT_std_c__14 = 1231, */                /* -std=c++14 */
  OPT_std_c__1y = 1232,                      /* -std=c++1y */
  OPT_std_c__98 = 1233,                      /* -std=c++98 */
  OPT_std_c11 = 1234,                        /* -std=c11 */
  /* OPT_std_c1x = 1235, */                  /* -std=c1x */
  /* OPT_std_c89 = 1236, */                  /* -std=c89 */
  OPT_std_c90 = 1237,                        /* -std=c90 */
  OPT_std_c99 = 1238,                        /* -std=c99 */
  /* OPT_std_c9x = 1239, */                  /* -std=c9x */
  OPT_std_f2003 = 1240,                      /* -std=f2003 */
  OPT_std_f2008 = 1241,                      /* -std=f2008 */
  OPT_std_f2008ts = 1242,                    /* -std=f2008ts */
  OPT_std_f95 = 1243,                        /* -std=f95 */
  OPT_std_gnu = 1244,                        /* -std=gnu */
  /* OPT_std_gnu__03 = 1245, */              /* -std=gnu++03 */
  /* OPT_std_gnu__0x = 1246, */              /* -std=gnu++0x */
  OPT_std_gnu__11 = 1247,                    /* -std=gnu++11 */
  /* OPT_std_gnu__14 = 1248, */              /* -std=gnu++14 */
  OPT_std_gnu__1y = 1249,                    /* -std=gnu++1y */
  OPT_std_gnu__98 = 1250,                    /* -std=gnu++98 */
  OPT_std_gnu11 = 1251,                      /* -std=gnu11 */
  /* OPT_std_gnu1x = 1252, */                /* -std=gnu1x */
  /* OPT_std_gnu89 = 1253, */                /* -std=gnu89 */
  OPT_std_gnu90 = 1254,                      /* -std=gnu90 */
  OPT_std_gnu99 = 1255,                      /* -std=gnu99 */
  /* OPT_std_gnu9x = 1256, */                /* -std=gnu9x */
  /* OPT_std_iso9899_1990 = 1257, */         /* -std=iso9899:1990 */
  OPT_std_iso9899_199409 = 1258,             /* -std=iso9899:199409 */
  /* OPT_std_iso9899_1999 = 1259, */         /* -std=iso9899:1999 */
  /* OPT_std_iso9899_199x = 1260, */         /* -std=iso9899:199x */
  /* OPT_std_iso9899_2011 = 1261, */         /* -std=iso9899:2011 */
  OPT_std_legacy = 1262,                     /* -std=legacy */
  OPT_symbolic = 1263,                       /* -symbolic */
  OPT_t = 1264,                              /* -t */
  OPT_time = 1265,                           /* -time */
  OPT_time_ = 1266,                          /* -time= */
  OPT_tno_android_cc = 1267,                 /* -tno-android-cc */
  OPT_tno_android_ld = 1268,                 /* -tno-android-ld */
  OPT_traditional = 1269,                    /* -traditional */
  OPT_traditional_cpp = 1270,                /* -traditional-cpp */
  OPT_trigraphs = 1271,                      /* -trigraphs */
  OPT_u = 1272,                              /* -u */
  OPT_undef = 1273,                          /* -undef */
  OPT_v = 1274,                              /* -v */
  OPT_version = 1275,                        /* -version */
  OPT_w = 1276,                              /* -w */
  OPT_wrapper = 1277,                        /* -wrapper */
  OPT_x = 1278,                              /* -x */
  OPT_z = 1279,                              /* -z */
  N_OPTS,
  OPT_SPECIAL_unknown,
